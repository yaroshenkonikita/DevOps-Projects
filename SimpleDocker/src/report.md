...
`docker build -t mod-nginx-fcgi:0.1 .`
...
://forms.yandex.ru/u/6357f52902848f350b554d5f/), **чтобы поделиться с нами обратной связью на этот проект**. Это анонимно и поможет команде Педаго сделать твоё обучение лучше.
